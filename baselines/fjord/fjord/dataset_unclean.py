...
# def partition(dataset, num_clients, concentration):
...
class FLCifar10Client(Dataset):
    ...
    def __init__(self, fl_dataset: Dataset, client_id: Optional[int] = None) -> None:
        ...
        self.partitions = self.partition(fl_dataset, fl_dataset.num_clients, fl_dataset.concentration)
    ...
    def set_client(self, index: Optional[int] = None) -> None:
        ...
        # else:
        #     """
        #     Extracts the indices for that particular client.
        #     """
...
class FLCifar10(CIFAR10):
    ...
    def __init__(  # pylint: disable=too-many-arguments
        ...
        # TODO: Extend to make it non-iid
        # Uniform shuffle
        # shuffle = np.arange(len(self.data))
        # rng = np.random.default_rng(12345)
        # rng.shuffle(shuffle)
        # self.partition = shuffle.reshape([num_clients, -1])
